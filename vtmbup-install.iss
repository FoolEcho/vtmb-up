...
[Setup]
AppName=Vampire: The Masquerade - Bloodlines unofficial patch 11.5.5 fr
AppVerName=Vampire: The Masquerade - Bloodlines unofficial patch 11.5.5 fr
VersionInfoDescription=Vampire: The Masquerade - Bloodlines unofficial patch avec sous-titrage français
VersionInfoVersion=11.5.5
...
Source: "{app}\Vampire\save\*"; DestDir: "{app}\Vampire\save"; Components: basic; Flags: external skipifsourcedoesntexist deleteafterinstall
Source: "{app}\Unofficial_Patch_fr\save\*"; DestDir: "{app}\Unofficial_Patch_fr\save"; Components: basic; Flags: external skipifsourcedoesntexist deleteafterinstall
...
Source: "Patch_Extras_fr\Developer Tools\Game Mod Loader\bin\loader\localization.ini"; DestDir: "{app}\Unofficial_Patch_fr\cfg"; MinVersion: 6.0; Components: basic; Flags: ignoreversion overwritereadonly
...
Type: filesandordirs; Name: "{app}\bin\loader\*"
Type: filesandordirs; Name: "{app}\Vampire\scripts"
Type: filesandordirs; Name: "{app}\Vampire\resource"

[Registry]
Root: HKCU; Subkey: "Software\Troika\Vampire"; Flags: deletekey noerror
